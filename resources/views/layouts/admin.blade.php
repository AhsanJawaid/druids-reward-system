...
<head>
    ...
    <title>@yield('title', 'Rewards admin')</title>
    ...
    <div class="wrap">
        <header class="admin-header">
            ...
            <nav class="nav">
                ...
                <a href="{{ route('storefront.home') }}">Shop</a>
            </nav>
        </header>
        @if (session('status'))
        ...
        @endif
        @yield('content')
        <footer>Connect Shopify under Shopify. Customers earn on paid orders and redeem for a discount code.</footer>
    </div>
</body>
</html>
